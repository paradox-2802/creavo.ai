    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-gray-600">
      ...
      >
        <div className="flex items-center gap-3">
          <Sparkles className="w-6 text-[#009BB3]"></Sparkles>
        ...
        <button
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#009BB3] to-[#00DA83] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer"
        >
          {loading ? (
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]">
        <div className="flex items-center gap-3">
          <FileText className="w-5 h-5 text-[#009BB3]"></FileText>
