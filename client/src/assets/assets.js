...
export const dummyTestimonialData = [
  {
    ...
    content:
      "Creavo.ai has revolutionized our content workflow. The quality of the articles is outstanding, and it saves us hours of work every week.",
    rating: 4,
  },
  {
    image: assets.profile_img_2,
    name: "Sarah Lee",
    title: "Content Strategist, Creativo",
    content:
      "Using Creavo.ai has drastically improved our content delivery timeline. It’s intuitive and incredibly reliable.",
    rating: 5,
  },
  {
    image: assets.profile_img_3,
    name: "Michael Chen",
    title: "SEO Lead, RankBoost",
    content:
      "We’ve seen a 30% uptick in organic traffic thanks to Creavo.ai’s blog generation tools. Highly recommended!",
    rating: 5,
  },
];
